...
export const RankChoices3: React.FC<IRankChoices> = ({ rank, openChoice, setOpenChoice, setOpportunity, opportunity }) => {
        ...
        : opportunity === 1 ?
          <Card anim>
            ...
            <Column>
              <OText>Upgrade</OText>
              <Spacing size={ESize.s} />
              <OButton>Upgrade my proxy</OButton>
            </Column>
          </Card>
          :
          <Card anim>
            ...
            <Card>
              <Column>
                <OText>Set owner</OText>
                <Spacing size={ESize.s} />
                <Gap onClick={handleChildClick} center>
                  <Input placeholder='set owner' />
